# Technical notes: chirality-group computations

This file preserves the definitions, derivations, implementation details, and
verification record behind the short [`README.md`](README.md). The two cases
are Roli's cube and `{12/(1,5),3,5}`. Full bibliographic details are in
[`references.md`](references.md).

Statements labelled **[verified]** are asserted by `verify.g` and recorded in
`results/`; **[transcript]** marks GAP output that can depend on its chosen
presentation; **[deduction]** marks a mathematical argument from the cited
sources; and **[cited]** marks source facts not recomputed here.
...
## 9. Files
    ...
    README.md                         short entry point and principal results
    TECHNICAL_NOTES.md                this document
